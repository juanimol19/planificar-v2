...
function handleSubmit(datos: DatosAnual | DatosDiaria) {
  datosFormulario.value = datos
  // TODO: reemplazar por el id real que devuelva el back
  planificacionId.value = 1
}
</script>
      ...
      <div v-if="mostrarModalVolver" class="modal-overlay">
        <div class="modal-volver">
          ...
          <div class="modal-volver-acciones">
            <button class="btn-modal-volver btn-modal-cancelar" @click="cancelarVolver">
              Cancelar
            </button>
...
.planificaciones-wrap .btn-volver:active {
  transform: scale(0.97);
}
.planificaciones-wrap .btn-volver:hover {
  background-color: #29ABE2;
  color: #ffffff;
  text-decoration: none;
}
.planificaciones-wrap .btn-volver .ti {
  font-size: 1rem;
}
...
.planificaciones-wrap .modal-volver-mensaje {
  font-size: 1rem;
  color: #1a2a3a;
  margin-bottom: 1.5rem;
  line-height: 1.5;
...
.planificaciones-wrap .modal-volver-acciones {
  display: flex;
  justify-content: flex-end;
  gap: 0.75rem;
}

.planificaciones-wrap .btn-modal-volver {
  display: inline-flex;
  align-items: center;
  gap: 0.4rem;
...
.planificaciones-wrap .btn-modal-cancelar {
  background-color: #e5e7eb;
  color: #1a2a3a;
}

.planificaciones-wrap .btn-modal-cancelar:hover {
  background-color: #d1d5db;
}

.planificaciones-wrap .btn-modal-confirmar {
  background-color: #c0392b;
  color: #ffffff;
}

.planificaciones-wrap .btn-modal-confirmar:hover {
  background-color: #a93226;
}

/* ── Modo oscuro ── */
.dark-mode .planificaciones-wrap .btn-volver {
  border-color: #33CCFF;
  color: #33CCFF;
}

.dark-mode .planificaciones-wrap .btn-volver:hover {
  background-color: #33CCFF;
  color: #1a1a1a;
}

.dark-mode .planificaciones-wrap .modal-volver {
  background-color: #1a1a1a;
  box-shadow: 0 8px 32px rgba(0, 0, 0, 0.5);
}

.dark-mode .planificaciones-wrap .modal-volver-mensaje {
  color: #ffffff;
}

.dark-mode .planificaciones-wrap .modal-volver-mensaje strong {
  color: #aabbcc;
}

.dark-mode .planificaciones-wrap .btn-modal-cancelar {
  background-color: #2a2a2a;
  color: #aabbcc;
}

.dark-mode .planificaciones-wrap .btn-modal-cancelar:hover {
  background-color: #333333;
}

.dark-mode .planificaciones-wrap .btn-modal-confirmar {
  background-color: #c0392b;
  color: #ffffff;
}

.dark-mode .planificaciones-wrap .btn-modal-confirmar:hover {
  background-color: #a93226;
}
</style>